...
- **Элджер Уилсон**/**Алгер Вилсон** - подчинённый шута, он же "Висельник" / "Повешенный"
...
## Языки:
- **Древний язык Гермес/Фусак** - составляет основу алфавита северных континентов (Fossic eng.)
...
- Данн Смит === Дэн Смит
- Рассел/Розель => Розелл
- Бэклэнд/Бэкленд/Баклунод —> Баклунд (переименование переводчика) 
...
- [Серебряный Град —> Город Серебра (City of Silver)]
