...
то вы можете прислать то что вы отредактировали локально в [issue](https://github.com/Demetri0/fb2-lord-of-the-mysteries/issues/new). Это конечно потратит больше моего времени и уменьшит
