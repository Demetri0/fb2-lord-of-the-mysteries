...
Хотя сам я уже не хочу/могу тратить время на этот проект,
я всё ещё с радостью приму вашу помощь если это будет готовый кусочек работы,
а не просто указание а-ля "вот тут бы как-нибудь улучшить" (хотя такое тоже можете слать в issue)

- [x] Многие главы в книге отформатированы ужаснейшим образом, не позволяющем нормально определить где реплика персонажа, а где его мысли;
- [ ] Многие главы в книге с очень плохим переводом: плохо связные предложения, множество точек о которые приходится спотыкаться при чтении, непонятно о чём идёт речь;
...
Коротко — всё что можете:

- Нашли ошибку/опечатку?
- Нашли несогласованность названий?
- Смогли перефразировать предложение/параграф чтобы он лучше звучал?
- Смогли подкорректировать обращение он/она?
- Смогли подкорректировать обарщение ты/вы?

В идиале будет если вы сможете прислать Pull Request с нужным исправлением.

Вариант чуть хуже: Можете создать issue или если совсем никак с предыдущими вариантами то прислать [мне в Telegram](https://t.me/Demetri0).

Присылайте кусочек старого текста (*постарайтесь захватить не слишком короткий, хотябы 5 и более слов влево-вправо от места ошибки*), чтобы я смог найти его через `Ctrl` + `F` и новый, исправленный вами вариант.

Оформляйте как-нибудь например так:

```
Это текст предложения с некоторой ошибкой
---
Это текст предложения с исправленной ошибкой

(А тут может быть ваш коментарий, если вам есть что сказать по поводу исправления)
```

Идеальным для меня вариантом взаимодействия будет непосредственно через github.com.
Вы можете создавать issue, и описывать найденные вами ошибки (по примеру выше), либо
прислать Pull Request непосредственно с внесёнными вами исправлениями.
