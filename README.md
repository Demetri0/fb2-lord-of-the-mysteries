...
то вы можете прислать то что вы отредактировали у себя локально, сюда в [issue](https://github.com/Demetri0/fb2-lord-of-the-mysteries/issues/new). Это конечно потратит больше моего времени и уменьшит
ценность вашей помощи, но всё же лучше чем ничего.
