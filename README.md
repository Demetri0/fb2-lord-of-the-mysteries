...
- Если вы хотите взяться за редактирование:
	...
	- Используйте только те варианты форматирования что указаны в этом файле в разделе [Форматирование](#форматирование). Даже если оно не идеально, его нужно менять по всему сайту, и если оно будет однообразно неправильно везде, то изменение этого займёт не более 10 минут, создайте issue если вы считаете что какое-либо форматирование можно улучшить и опишите ваше видение;
