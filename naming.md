...
- **Маг** / Фокусник - Форс Уолл, подруга Одри Холл
...
- Secrets Supplicant / Проситель [секретов] №9 / Тайный Проситель / Искателем Тайн
	...
	- Священник Розы №6 / Епископ Роз / Роуз Бишоп / Роза Бишоп / розового епископа
...
- кепка =?= шляпа
- Запредельщиком === Потусторонним === выходцев за пределы галактики = Бейондеры
...
- зачистку дневного города === Послеполуденный Город === послеобеденный город === дневной город === полуденный город
