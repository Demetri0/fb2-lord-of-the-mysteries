...
- Путь Темного Императора (названия должны соответствовать пути Демонессы, но с префиксами, Вместо Порочности — Порочный Барон, Смятения — Гуру Смятения, Падшей — Граф Падших, Хаоса — Принц Хаоса. -?- возможно перепутан с путём охотника)
	...
	- Порочный Барон №6 / Барон Искажения / барона коррупции
	- Гуру Смятения №5
	- Граф Падших №4
	- Неистовый Чародей №3
	- Герцог Беспорядка №2
...
- Нуминозный Епископат === Нуменозный Епископат === Запредельный Епископат === Потусторонний Епископат === сверхъестественного члена епископата === Зловещий Епископат === Непостижимый Епископат === Нуминологическом Епископате
...
- зачистку дневного города === Послеполуденный Город
